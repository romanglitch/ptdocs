...
export const PlantHeader = (props: any) => {
	...
	return (
		<div className={'plant-header w-fit left-0 right-0 ml-auto mr-auto fixed transition-all flex gap-3 items-center p-2 font-normal text-small bg-content1 subpixel-antialiased overflow-hidden rounded-large'}>
			<div>
			...
			<div>
				<p className={'text-md'}>{formatDays(props.allDays.length)} <span>({formatDays(props.allDays.length, true)})</span></p>
